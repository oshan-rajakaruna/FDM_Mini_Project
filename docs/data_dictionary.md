...
| RainToday | Binary indicator whose observed dataset convention is Rainfall > 1.0 mm; this differs at the exact 1.0 mm boundary from the proposal wording "1 mm or more". | str | categorical binary | No/Yes; T04-observed convention is Rainfall > 1.0 mm | predictor | 3,261 missing (2.2419%); 2 unique non-null values. | Preserve categories; missing-value handling and encoding are deferred. |
